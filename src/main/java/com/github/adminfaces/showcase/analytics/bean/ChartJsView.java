...
public class ChartJsView implements Serializable {
    ...
    private void createPieModel() {
        ...
        bgColors.add("rgb(0, 240, 124)");
        bgColors.add("rgb(117, 201, 161)");
        bgColors.add("rgb(247, 230, 101)");
         bgColors.add("rgb(194, 23, 8)");
        dataSet.setBackgroundColor(bgColors);
        
        /*
               borderColor.add("rgb(0, 240, 124)");
        borderColor.add("rgb(117, 201, 161)");
        borderColor.add("rgb(247, 230, 101)");
        borderColor.add("rgb(194, 23, 8)");
        */
    ...
    public void createBarModel() {
        ...
        bgColor.add("rgba(0, 240, 124, 0.2)");
        bgColor.add("rgba(117, 201, 161, 0.2)");
        bgColor.add("rgba(247, 230, 101, 0.2)");
        bgColor.add("rgba(194, 23, 8, 0.2)");
